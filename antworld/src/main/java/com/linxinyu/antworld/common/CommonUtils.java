package com.linxinyu.antworld.common;
...
public class CommonUtils {
    public static String getChineseFamilyName() {
        String str = null;
        Random random = new Random(System.currentTimeMillis() + randomNum(0, 1000));
        /* 598 百家姓 */
...
//    getChineseGivenName方法具体实现如下
    ...
    public static String getNewName() {
        return StrUtil.format("{}{}", CommonUtils.getChineseFamilyName(), CommonUtils.getChineseGivenName());
    }
